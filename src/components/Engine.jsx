...
const features = [
  {
    ...
    desc: 'Define investigation flows in YAML with reusable steps — connector calls, data transforms, conditional branching, and notifications. Built-in retry and variable interpolation.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Multi-factor weighted scoring across freshness, source reliability, correlation, and reputation. Three score types — threat, confidence, and priority — each with configurable weights.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Parse investigative questions in natural language and automatically translate to SQL or Cypher. Supports Ollama (local) and OpenAI as interchangeable LLM backends.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Plugin architecture for integrating external platforms using a simple interface. Connectors are discovered at runtime and callable from playbooks via the connector_call step.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  {
    title: 'REST API',
    desc: 'Full-featured API with 15+ endpoints for managing investigations, playbooks, scoring, and queries. Auto-generated Swagger documentation at /docs with interactive testing.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'SQLAlchemy async with SQLite for development and PostgreSQL for production. Clean repository pattern separates persistence from business logic for testability.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className={`max-w-2xl transition-all duration-700 ${
          ...
          <p className="mt-4 text-lg text-slate-500 leading-relaxed">
            A modular, API-first intelligence engine designed to be embedded into any OSINT platform. All features are accessible through a consistent REST interface.
          </p>
        </div>
